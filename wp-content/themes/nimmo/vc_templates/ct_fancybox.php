...
?>
<div class="ct-fancybox-default <?php echo esc_attr($style.' '.$el_class.' '.$animation_classes); ?>" <?php if(!empty($box_image_url)) : ?>style="background-image: url(<?php echo esc_url($box_image_url); ?>);" <?php endif; ?>>
