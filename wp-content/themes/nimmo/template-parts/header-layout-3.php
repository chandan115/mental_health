...
$header_type = nimmo_get_opt( 'header_type', 'light' );
$header_layout = nimmo_get_opt( 'header_layout', '1' );

$header_type_page = nimmo_get_page_opt( 'header_type', 'light' );
$header_layout_page = nimmo_get_page_opt( 'header_layout', '1' );
if($custom_header  && $header_layout_page != '0' ) {
...
?>
<header id="masthead">
    <div id="header-wrap" class="header-layout3 <?php if($header_layout == '3') { echo 'type-'.esc_attr($header_type); } ?> <?php if($sticky_on == 1) { echo 'is-sticky'; } else { echo 'no-sticky'; } ?>">
